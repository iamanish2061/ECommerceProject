...
public class ServiceController {
    ...
    public ResponseEntity<ApiResponse<List<ServiceListResponse>>> getAllActiveServices() {
        return ResponseEntity.ok(
                ApiResponse.ok(salonServiceService.getAllActiveServices(), "Fetched active services successfully"));
    }
    ...
    public ResponseEntity<ApiResponse<List<ServiceListResponse>>> getServicesByCategory(
        ...
        return ResponseEntity.ok(
                ApiResponse.ok(salonServiceService.getServicesByCategory(category), "Fetched services of category: "+category));
    }
    ...
    public ResponseEntity<ApiResponse<List<ServiceListResponse>>> searchServices(
        ...
        return ResponseEntity.ok(
                ApiResponse.ok(salonServiceService.searchServices(query), "Fetched services related to search: : "+query));
    }
    ...
    public ResponseEntity<ApiResponse<ServiceDetailResponse>> getServiceDetail(
        ...
        return ResponseEntity.ok(
                ApiResponse.ok(salonServiceService.getServiceDetail(id), "Fetched detail of service :"+id+" successfully!"));
    }
    ...
    public ResponseEntity<ApiResponse<List<String>>> getAllCategories() {
        return ResponseEntity.ok(
                ApiResponse.ok(salonServiceService.getAllCategories(), "Fetched all categories successfully"));
    }
}
